    ...
    <tr>
        ...
        <td>
            ...
            <%
                ...
                if (action != null && action.equals("insert")) {
                	...
                	// Check if the student is working on a bs/ba degree
                		...
                		rs = stmt.executeQuery("SELECT * from student where u_id = " + tempSid);
                		if( rs.next() ){
                	...
                	if( stuDegreeMatch ) {
                		...
                		while( rs.next() && conti ){
                			...
                			rs2 = stmt.executeQuery( "SELECT * from Requirement where require_id = " + requireId );
                			if( rs2.next() ){
                				...
                				if( (rs2.getString("degree").equals(tempDegree)) ) { 
                					...
                					rs3 = stmt.executeQuery(" SELECT Section_Enrolllist.grade_option AS unit, "
                					...
                					while( rs3.next() ){
                						classTaken.add(rs3.getInt("classTaken"));
                		...
                		if( conti && tempDegree.equals("master") ) {
                			...
                			while( classesTaken.hasNext() ){
                				ResultSet rs4 = stmt.executeQuery( "SELECT DISTINCT Course.course_id AS course "
                						+ " FROM Course, Class" 
                			...
                			ResultSet rs5 = stmt.executeQuery( "SELECT * FROM Concentration_course"
            ...
            <%
                ...
                rs = statement.executeQuery("SELECT * FROM Other_degree");
            %>
